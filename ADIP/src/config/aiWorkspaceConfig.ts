...
export const AI_WORKSPACE_CONFIGS: Record<AIWorkspaceModule, AIWorkspaceConfig> = {
  ...
  development: {
    ...
    mode: 'generate',
    promptLabel: 'Describe development implementation request',
    placeholder: 'e.g. Generate microservice implementation plan',
    suggestedPrompts: [
  ...
  executive: {
    ...
    subtitle: 'CIO automation cockpit — decisions, risks, technology health, investment, daily briefing',
    mode: 'ask',
    promptLabel: 'Ask the executive AI',
    placeholder: "e.g. Today's CIO Briefing",
    suggestedPrompts: [
    ...
    glow: 'purple',
    artifactSummary: ['CIO Briefing', 'Portfolio Health Report', 'Strategic Risk Report', 'Board Presentation'],
    governance: {
