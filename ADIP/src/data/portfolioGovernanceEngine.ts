...
export function generateAiInsights(): AiInsight[] {
  ...
  return [
    ...
    },
    {
      ...
      recommendation: `Rebalance ${PG_PORTFOLIOS[2].name} — health at ${PG_PORTFOLIOS[2].healthScore}% vs portfolio avg ${kpis.portfolioHealth}%. Security Hardening leads; Core Banking Renewal and Cloud Migration remain weak. Shift 2 programs to ${PG_PORTFOLIOS[7].name}.`,
      confidence: 82,
      impact: 'high',
    ...
    },
    {
      ...
      recommendation: `Enterprise alignment ${kpis.strategicAlignment}% — "Innovation & AI" objective under-funded vs weight. Observability-linked demands and FIU compliance gaps (61%) drag alignment; Security-aligned portfolios remain strongest. Deprioritize 4 demands misaligned below 55%.`,
      confidence: 84,
      impact: 'medium',
