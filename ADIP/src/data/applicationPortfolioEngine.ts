...
export function generateApmAiInsights(): ApmAiInsight[] {
  ...
  return [
    ...
    },
    {
      ...
      recommendation: `42 apps ready for rehost, 28 for replatform. Prioritize APP-0156 (cloud score 92%) for Q3 migration wave.`,
      confidence: 84,
      impact: 'high',
    ...
    },
    {
      ...
      recommendation: `Enterprise AI readiness ${kpis.aiReadiness}%. Top candidates: fraud scoring (APP-0224), document extraction (APP-0312). Data quality gaps in 18 apps.`,
      confidence: 82,
      impact: 'medium',
    ...
    },
    {
      ...
      recommendation: `Core Banking Renewal portfolio has highest risk density: ${APM_TECH_RISKS.filter((r) => r.severity === 'critical').length} critical technology risks open.`,
      confidence: 88,
      impact: 'high',
