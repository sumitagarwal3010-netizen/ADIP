  ...
  return [
    {
      ...
      recommendation: `${nonCompliant.length} applications non-compliant with mandatory standards. Standards compliance at ${kpis.standardsCompliance}%. Security is strongest at 93%; Observability (49%) and FIU-linked controls (61%) are the weakest gaps. Prioritize ${nonCompliant[0]?.name ?? 'top app'} for ARB remediation.`,
      confidence: 88,
      impact: 'high',
    ...
    },
    {
      ...
      recommendation: `Cloud readiness ${kpis.cloudReadiness}%. GCP adoption lags at 48% while AWS leads at 89%. 38 applications ready for cloud-native refactor aligned to REF-02 Microservices reference.`,
      confidence: 82,
      impact: 'high',
    ...
    },
    {
      ...
      recommendation: `Secure-by-Design / Security standards lead at 93%. Observability maturity remains weak at 49% — 11 applications lack encryption-at-rest aligned to REF-03 Secure API Gateway pattern; lift Observability before new builds.`,
      confidence: 85,
      impact: 'high',
