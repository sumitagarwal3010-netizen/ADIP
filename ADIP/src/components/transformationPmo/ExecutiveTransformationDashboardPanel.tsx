 ...
 * 10 KPIs → 5 hero KPIs. Removed as overlapping/PMO noise:
 *   - Program Delivery, Objective Achievement (eclipsed by Transformation Health)
 *   - BU Performance, Executive Commitments, Board Readiness (overlap noise)
 */
