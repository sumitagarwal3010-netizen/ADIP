...
const pageMeta: Record<string, { title: string; subtitle: string }> = {
  ...
  '/executive/transformation-pmo': { title: 'Enterprise Transformation PMO', subtitle: 'Executive transformation oversight' },
  '/executive/transformation-pmo/programs': { title: 'Enterprise Transformation PMO', subtitle: 'Transformation programs' },
  '/executive/transformation-pmo/initiatives': { title: 'Enterprise Transformation PMO', subtitle: 'Strategic initiatives' },
  '/executive/transformation-pmo/objectives': { title: 'Enterprise Transformation PMO', subtitle: 'Objectives & OKRs' },
  '/executive/transformation-pmo/milestones': { title: 'Enterprise Transformation PMO', subtitle: 'Milestones' },
  '/executive/transformation-pmo/benefits': { title: 'Enterprise Transformation PMO', subtitle: 'Benefits tracking' },
  '/executive/transformation-pmo/commitments': { title: 'Enterprise Transformation PMO', subtitle: 'Executive commitments' },
  '/executive/transformation-pmo/dependencies': { title: 'Enterprise Transformation PMO', subtitle: 'Cross-program dependencies' },
  '/executive/transformation-pmo/risks': { title: 'Enterprise Transformation PMO', subtitle: 'Transformation risks' },
  '/executive/transformation-pmo/business-units': { title: 'Enterprise Transformation PMO', subtitle: 'Business unit performance' },
  '/executive/transformation-pmo/insights': { title: 'Enterprise Transformation PMO', subtitle: 'Executive insights and AI advisors' },
  '/executive/transformation-pmo/reports': { title: 'Enterprise Transformation PMO', subtitle: 'AI-generated transformation reports' },
